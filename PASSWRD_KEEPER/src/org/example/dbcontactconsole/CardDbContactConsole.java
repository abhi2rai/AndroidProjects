...
public class CardDbContactConsole extends ListActivity {
	private static String[] FROM1 = { _ID, DbConstants.BANK_CARD_NAME, DbConstants.CARD_NO, DbConstants.SECRET_PIN_NO, DbConstants.C_NOTES,  };
	   private CardDbCreate contacts1;
	   private static SQLiteDatabase db1;
	   private static int[] TO1 = { R.id.rowid, R.id.bcard_name, R.id.card_no, R.id.card_Pin_no, R.id.bc_notes };
		   ...
		   switch (item.getItemId()){
		       case R.id.modifyitem:
		    	   if(null != itemId){
		    		   ...
		    		   contactToModify1.putString("cCard_No", cursor1.getString(2));
		    		   ...
		    		   intent.setClass(this, CardDetails.class);
		       ...
		       case R.id.additem:
		    	   Intent i1 = new Intent(this, CardDetails.class);
		    	   Bundle bun1 = new Bundle();
		    	   bun1.putString("mod_type", "addPerson1");
		    	   i1.setClass(this, CardDetails.class);
		    	   i1.putExtras(bun1);
	 ...
	 //method removes item from database
	   private void removeContact(String itemId){
    	   ...
    	   db1.delete(DbConstants.TABLE_NAME3, " _ID= " + itemId, null);
	   ...
	   private void addContact(Bundle bundle) {
		      ...
		      vals.put(DbConstants.BANK_CARD_NAME, bundle.getString("contactbankName"));
			  vals.put(DbConstants.CARD_NO, bundle.getString("contactCard"));
			  vals.put(DbConstants.SECRET_PIN_NO, bundle.getString("contactPin"));
			  vals.put(DbConstants.C_NOTES, bundle.getString("contactNotes"));
			  
			  db1.insertOrThrow(DbConstants.TABLE_NAME3, null, vals);
		   }
	 ...
	 //method should modify existing Contact
	   private void modifyContact(Bundle bundle){
		   ...
		   db1.update(DbConstants.TABLE_NAME3, vals, _ID + " = " + itemId, null);
	   }

	   private Cursor getContacts() {
		      db1 = contacts1.getReadableDatabase();
		      cursor1 = db1.query(DbConstants.TABLE_NAME3, FROM1, null, null, null, null, null);
		      startManagingCursor(cursor1);
		      return cursor1;
	   }
	   
	   public void showDatabaseContent1(){
		   contacts1 = new CardDbCreate(this); 
		   try {
		       cursor1 = getContacts(); 
	   ...
	   private void showContacts(Cursor cursor) {
	       //set up data binding
		   SimpleCursorAdapter adapter = new SimpleCursorAdapter(this, R.layout.card_item, cursor, FROM1, TO1);
